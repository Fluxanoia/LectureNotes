...
\subsection{\textbf{Divide and Conquer}: Peak Finding}
...
\subsection{\textbf{Dynamic Programming}: Calculating Fibonacci Numbers}
...
\subsection{\textbf{Dynamic Programming}: Pole Cutting}
...
\subsection{\textbf{Dynamic Programming}: Matrix Chain Parenthesisation}
