...
\end{verbatim} We have that the time complexity of the algorithm
...
following algorithm: \begin{verbatim}
  LargestSquare(x, y)
  ...
  >   LargestSquare(x, y - 1)
  > )
\end{verbatim} The time complexity of this algorithm, however,
is exponential.
\\[\baselineskip]
...
where each cell is undefined as first: \begin{verbatim}
  LargestSquare_Stored(x, y)
  ...
  > )
  > return A[x, y]
\end{verbatim} This can be adapted to work iteratively from
